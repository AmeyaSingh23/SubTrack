        ...
        <div className="space-y-16">
          ...
          <section>
            ...
            <div className="border-t border-[var(--border)] pt-6 text-[var(--text-primary)] leading-relaxed space-y-4">
              ...
              <p className="text-[var(--text-secondary)] text-sm border-l-2 border-[var(--accent)] pl-4">
          ...
          <section>
            ...
            <div className="border-t border-[var(--border)] pt-6 text-[var(--text-primary)] leading-relaxed space-y-4">
              ...
              <ul className="space-y-2 ml-6">
                <li className="before:content-['—'] before:mr-3 before:text-[var(--accent)]">Sign in with a valid Google account</li>
                <li className="before:content-['—'] before:mr-3 before:text-[var(--accent)]">Be at least 13 years of age</li>
                <li className="before:content-['—'] before:mr-3 before:text-[var(--accent)]">Provide accurate information about your subscriptions</li>
              </ul>
              <p>
          ...
          <section>
            ...
            <div className="border-t border-[var(--border)] pt-6 text-[var(--text-primary)] leading-relaxed space-y-4">
              ...
              <ul className="space-y-2 ml-6">
                <li className="before:content-['—'] before:mr-3 before:text-[var(--accent)]">Uptime or availability</li>
                <li className="before:content-['—'] before:mr-3 before:text-[var(--accent)]">Accuracy of reminder delivery times</li>
                <li className="before:content-['—'] before:mr-3 before:text-[var(--accent)]">Long-term service continuity</li>
                <li className="before:content-['—'] before:mr-3 before:text-[var(--accent)]">Data backup or recovery</li>
              </ul>
          ...
          <section>
            <div className="flex items-baseline gap-4 mb-6">
              <span className="text-[var(--accent)] text-xs uppercase tracking-widest">08</span>
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            ...
            <div className="flex gap-8">
              ...
              <Link href="/privacy" className="text-[var(--text-secondary)] text-sm hover:text-[var(--accent)] transition-colors">
                Privacy
              </Link>
            </div>
          </div>
